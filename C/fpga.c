...
bool FPGAInit()
{
    ...
    if (m_file_mem != -1){
	    ...
	    m_pwm_base= (uint8_t *)virtual_base + ( ( unsigned long  )( ALT_LWFPGASLVS_OFST + FPGA_PWM_BASE ) & ( unsigned long)( HW_REGS_MASK ) );
